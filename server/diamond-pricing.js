'use strict';
// Fixed-point decimal arithmetic: reference gross HUF -> hundredths -> whole HUF.
...
function price(referenceGross){return Number(halfUp(decimalMinor(referenceGross)*90n,10000n));}
...
function priceStatus(stone,now=Date.now()){
 ...
 if(stone.sourceStatus!=='verified'||stone.referenceSource!=='noordia'||stone.referenceVatIncluded!==true)return 'unverified';
