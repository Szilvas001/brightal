...
export class DiamondViewer extends RingRenderer {
 ...
 constructor(host,stone,onError){
  ...
  geometry.computeBoundingBox();const size=geometry.boundingBox.getSize(new T.Vector3());gem.scale.set(stone.width/size.x,stone.height/size.y,stone.length/size.z);gem.userData.gem=true;this.group.add(gem);this.gems=[gem];
